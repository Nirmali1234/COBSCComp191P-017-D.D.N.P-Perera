...
//
//        let pin : CLLocationCoordinate2D = CLLocationCoordinate2DMake(CLLocationDegrees(personList[2].latitude1), CLLocationDegrees(personList[2].longitude1))
...
//            let pin : CLLocationCoordinate2D = CLLocationCoordinate2DMake(CLLocationDegrees(personList[i].latitude1), CLLocationDegrees(personList[i].longitude1))  //(personList[i].latitude1, personList[i].longitude1)
//            
//            let annotation = MKPointAnnotation()
//            annotation.coordinate = pin
